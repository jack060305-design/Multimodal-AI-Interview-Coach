...
Write-Host "  ANTHROPIC_API_KEY=optional (LLM — recommended)"
Write-Host "  GOOGLE_API_KEY=optional (LLM via Gemini)"
Write-Host "  OPENAI_API_KEY=optional (Whisper on cloud + OpenAI LLM)"
Write-Host "  LANGSMITH_API_KEY=optional (agent tracing)"
Write-Host ""
